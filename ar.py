...
LEG_BACK = 1812
VERTICAL_HEAD = 2048
X_BENCHMARK = [200, 203, 203, 203, 204] #改大射左 #[最左,中左,中間,中右,最右]
Y_BENCHMARK = 158 #改大射高
SHOOT_DELAY = 0.64 #改大變快 0.65距離拉遠時比較好,0.64只適合線上     0.65中速靶一二箭ok, 0.65三中右快速靶偏下且箭胚掉, 0.64四慢速中左delay要再慢 ,0.64最右中慢靶頭掉包重撥還是不行
